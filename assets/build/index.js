...
/* harmony import */ var _storeTranslatedString__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../storeTranslatedString */ "./src/component/storeTranslatedString/index.js");
...
const localAiTranslator = async props => {
  ...
  const afterTranslate = ele => {
    ...
    (0,_storeTranslatedString__WEBPACK_IMPORTED_MODULE_2__["default"])({
      type: type,
      key: key,
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _stringModalScroll__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../stringModalScroll */ "./src/component/stringModalScroll/index.js");
...
/***/ "./src/component/createTranslatedPost/SeoMetaFields/RankMathSeo.js":
/*!*************************************************************************!*\
  !*** ./src/component/createTranslatedPost/SeoMetaFields/RankMathSeo.js ***!
  \*************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/component/createTranslatedPost/SeoMetaFields/YoastSeoFields.js":
/*!****************************************************************************!*\
  !*** ./src/component/createTranslatedPost/SeoMetaFields/YoastSeoFields.js ***!
  \****************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _SeoMetaFields_YoastSeoFields__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./SeoMetaFields/YoastSeoFields */ "./src/component/createTranslatedPost/SeoMetaFields/YoastSeoFields.js");
/* harmony import */ var _AllowedMetafileds__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../AllowedMetafileds */ "./src/AllowedMetafileds.js");
/* harmony import */ var _SeoMetaFields_RankMathSeo__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./SeoMetaFields/RankMathSeo */ "./src/component/createTranslatedPost/SeoMetaFields/RankMathSeo.js");
  ...
  const postMetaFieldsUpdate = () => {
    ...
    Object.keys(metaFieldsData).forEach(key => {
      ...
      if (Object.keys(_AllowedMetafileds__WEBPACK_IMPORTED_MODULE_3__["default"]).includes(key) && _AllowedMetafileds__WEBPACK_IMPORTED_MODULE_3__["default"][key].type === 'string') {
        const translatedMetaFields = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_1__.select)('block-atfp/translate').getTranslatedString('metaFields', metaFieldsData[key][0], key);
...
/* harmony export */ });
/* harmony import */ var _FilterNestedAttr__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../FilterNestedAttr */ "./src/component/FilterNestedAttr/index.js");
/* harmony import */ var _AllowedMetafileds__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../AllowedMetafileds */ "./src/AllowedMetafileds.js");
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _AllowedMetafileds__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../AllowedMetafileds */ "./src/AllowedMetafileds.js");
const {
  dispatch
} = wp.data;
...
/***/ "./src/component/stringModalScroll/index.js":
/*!**************************************************!*\
  !*** ./src/component/stringModalScroll/index.js ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
 ...
 * @returns {Object} The action object containing the type, text, id, and source.
 */
const metaFieldsSaveTranslate = (id, data, source) => {
  return {
...
/* harmony import */ var _fetch_post__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./fetch-post */ "./src/popupStringModal/fetch-post.js");
...
/***/ "./src/popupStringModal/fetch-post.js":
/*!********************************************!*\
  !*** ./src/popupStringModal/fetch-post.js ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
