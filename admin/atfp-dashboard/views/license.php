<div class="atfp-dashboard-license">
    ...
    <div class="atfp-dashboard-upgrade-box">
        <p>
            ...
            <a href="https://coolplugins.net/product/autopoly-ai-translation-for-polylang/?utm_source=atfp_plugin&utm_medium=inside&utm_campaign=get_pro&utm_content=license" target="_blank"><?php esc_html_e('upgrading to Pro', $text_domain); ?></a>.
        </p>
