<div class="atfp-dashboard-info">
    <div class="atfp-dashboard-info-links">
        ...
        <a href="https://coolplugins.net/support/?utm_source=atfp_plugin&utm_medium=inside&utm_campaign=support&utm_content=dashboard_header" target="_blank"><?php esc_html_e('Support', $text_domain); ?></a> |
        <a href="https://docs.coolplugins.net/docs/ai-translation-for-polylang/" target="_blank"><?php esc_html_e('Docs', $text_domain); ?></a>
