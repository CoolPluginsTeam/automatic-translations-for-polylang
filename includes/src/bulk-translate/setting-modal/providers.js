...
const Providers = (props) => {
  ...
  const handleCardClick = () => {
    if (isDisabled && 'localAiTranslator' === service && props.localAiModalError) {
      props.openErrorModalHandler(props.localAiModalError);
      return;
    }
    if (isDisabled && 'yandex' === service && props.yandexDisabled) {
      props.openErrorModalHandler(props.yandexDisabled);
      return;
    }
